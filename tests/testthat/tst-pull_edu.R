...
test_that("errors work", {
  ...
  # standard errors
  expect_error(pull_edu(endyear= 2016, span=0, ca_counties))
  expect_error(pull_edu(endyear= 2016, span= -1, ca_counties))
  expect_error(pull_edu(endyear= 2016, span= 7, ca_counties))
